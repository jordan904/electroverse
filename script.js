...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Scroll animations ---
    document.querySelectorAll('.about-media, .contact-info').forEach(el => el.classList.add('reveal-left'));
    document.querySelectorAll('.about-text, .contact-form-wrap').forEach(el => el.classList.add('reveal-right'));
    ...
    document.querySelectorAll('.section-header, .about-highlights, .trust-bar').forEach(el => el.classList.add('reveal'));
